...
def mask_alexnet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_densenet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_efficientnet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_googlenet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_inception(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_mobilenet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_regnet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_resnet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_shufflenet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_squeezenet(per, top, mantissa_bits=10, exponent_bits=5):
...
def mask_vgg(per, top, mantissa_bits=10, exponent_bits=5):
    model = models.vgg16()
    x = torch.randn(1, 3, 224, 224)
    model_params = {var: name for name, var in model.named_parameters()}
    statedict_kqi = {}
...
def mask_vit(per, top, mantissa_bits=10, exponent_bits=5):
