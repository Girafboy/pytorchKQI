    ...
    class TestTransformerEncoder(torch.nn.Module, kqinn.KQI):
        ...
        def true_kqi(self):
            ...
            for i in range(head):
                for j in range(sequence_length):
                    for k in range(sequence_length):
                        preds = ([f'L2_Q_{j}-{i * head_dim + m}' for m in range(head_dim)] + [f'L2_K_{k}-{i * head_dim + m}' for m in range(head_dim)])
            ...
            for i in range(head):
                for j in range(sequence_length):
                    for k in range(head_dim):
                        preds = ([f'L6_{j}-{i * sequence_length + m}' for m in range(sequence_length)] + [f'L2_V_{m}-{i * head_dim + k}' for m in range(sequence_length)])
            ...
            for i in range(head):
                for j in range(sequence_length):
                    for k in range(sequence_length):
                        preds = ([f'L15_Q_{j}-{i * head_dim + m}' for m in range(head_dim)] + [f'L15_K_{k}-{i * head_dim + m}' for m in range(head_dim)])
            ...
            for i in range(head):
                for j in range(sequence_length):
                    for k in range(head_dim):
                        preds = ([f'L19_{j}-{i * sequence_length + m}' for m in range(sequence_length)] + [f'L15_V_{m}-{i * head_dim + k}' for m in range(sequence_length)])
